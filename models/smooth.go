...
func (h *smoothManifest) AddOutput(output *Output) {
	h.Outputs = append(h.Outputs, *output)
}

type smoothManifestData struct {
	//Success fields
	Result   smoothManifest `json:"result,omitempty"`
...
type smoothManifestResponse struct {
	RequestID *string                      `json:"requestId,omitempty"`
	Status    bitmovintypes.ResponseStatus `json:"status,omitempty"`
	Data      smoothManifestData              `json:"data,omitempty"`
}

type LivesmoothManifest struct {
